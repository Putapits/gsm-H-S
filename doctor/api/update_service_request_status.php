...
try {
  ...
  $stmt = $db->prepare('UPDATE service_requests SET status = :s, updated_at = CURRENT_TIMESTAMP WHERE id = :id');
  ...
  error_log('doctor/update_service_request_status error: ' . $e->getMessage());
