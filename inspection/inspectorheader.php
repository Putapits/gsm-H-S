...
<head>
  ...
  <title>Inspector Dashboard - Health & Sanitation</title>
  ...
  <style>
    ...
    html:not(.dark) nav.bg-dark-bg,
    html:not(.dark) nav.bg-surface { background-color: var(--color-surface) !important; border-color: var(--color-border) !important; }
    ...
    html:not(.dark) .bg-background { background-color: var(--color-background) !important; }
        ...
        <div class="flex items-center">
          ...
          <div class="flex items-center">
            <div class="ml-3">
              ...
              <p class="text-sm text-gray-400">Inspector Portal</p>
            </div>
          </div>
        </div>
